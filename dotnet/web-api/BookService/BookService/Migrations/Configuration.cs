        ...
        protected override void Seed(BookServiceContext context)
        {
            context.Authors.AddOrUpdate(x => x.Id,
                new Author[]
                {
                    ...
                    new Author() { Id = 3, Name = "Barry White"}
                });
            ...
            context.Books.AddOrUpdate(x => x.Id,
                new Book[]
                {
                    ...
                    new Book() { Id = 3, Title = "David Copperfield", Year = 1850, AuthorId = 2, Price = 15, Genre = "Bildingsroman" },
                    new Book() { Id = 4, Title = "Don Quixote", Year = 1617, AuthorId = 3, Price = 8.95M, Genre = "Picareque" },
                });
